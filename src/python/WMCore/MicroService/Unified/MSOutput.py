...
from WMCore.Services.DDM.DDM import DDM
from WMCore.Services.DDM.DDM import DDMTemplate
...
class MSOutput(MSCore):
    ...
    def __init__(self, msConfig, logger=None):
        ...
        self.msConfig.setdefault("enableDataPlacement", True)
        ...
        self.msConfig.setdefault("rucioAccount", RUCIO_ACCT)
        self.uConfig = {}
    ...
    def makeSubscriptions(self, workflows=[]):
        ...
        else self.msConfig['defaultDataManSys'] = 'Rucio':
            pass
